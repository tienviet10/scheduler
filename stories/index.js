...
storiesOf("Appointment", module)
  ...
  .add("Status", () => <Status message="Could not delete appointment." />)
  .add("Error", () => <Error message="Deleting" onClose={action('onClose')} />)
  .add("Edit", () => <Form student="Viet" interviewer={1} interviewers={interviewers} onSave={action('onSave')} onCancel={action('onCancel')} />)
